...
void generateForDomainClass(domainClass) {
	def EasyuiGrailsTemplateGenerator  = classLoader.loadClass('org.grails.plugins.easyui.scaffolding.EasyuiGrailsTemplateGenerator')

	def templateGenerator = EasyuiGrailsTemplateGenerator.newInstance(classLoader)
